...
\begin{equation}
$\implies$ $ \lambda^2 = \lambda $ then $ \lambda^2 - \lambda = 0 $ \\
\end{equation}
Then $ (I+A)^3 - 7A $ can be written as $ (I+\lambda)^3 - 7\lambda $\\
$ (I+\lambda)^3 - 7\lambda  = I^3+\lambda^3+3I^2\lambda+3\lambda^2I - 7\lambda$\\
we know that $ I^3 = I^2 = I $\\
$ = I+\lambda^3+3I\lambda+3\lambda^2I-7\lambda$\\
$ = I+\lambda^3+3\lambda+3\lambda^2-7\lambda$\\
$ = I+(\lambda^2\lambda)+3\lambda+3\lambda -7\lambda$\\
$ = I+(\lambda\lambda)-\lambda$\\
$ = I+\lambda^2-\lambda$\\
From the equation$(2.0.1)$ $ \lambda^2-\lambda = 0 $\\
$ = I+0$\\
$ = I$\\
\section{answer}
